...
public class Scaler
{
     ...
     * @return The scaled number
     */
    public static double scale(int ubData, int lbData, double ubScaled, double lbScaled, double numToBeScaled)
    {
        return ((ubScaled - lbScaled) * (numToBeScaled - lbData)) /(float) (ubData - lbData) + lbScaled;
    }
}
